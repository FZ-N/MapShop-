...
public class ProductDetailsActivity extends AppCompatActivity
{
    ...
    private String productID = "", state = "Normal",cat;
    ...
    private void addingToCartList(String name)
    {
        ...
        cartListRef.child("User View").child(name)
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task)
                    {
                        ...
                        {  final String saveCurrentDate;
                            ...
                            cartListRef.child("Admin View").child(name).child(saveCurrentDate)
                                    .child("Products").child(productID)
                                    .updateChildren(cartMap)
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        @Override
    ...
    {
        DatabaseReference productsRef = FirebaseDatabase.getInstance().getReference().child("Cat").child(cat);
